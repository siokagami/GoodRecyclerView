...
/**
 * Created by yilun.xin on 2016/5/21.
 */
...
public class GoodRecyclerView extends FrameLayout {
    ...
    private GoodRecyclerViewAdapter adapter;
    ...
    public GoodRecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }
    public GoodRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    private void init() {
    ...
    public void setAdapter(RecyclerView.Adapter adapter) {
        this.adapter = new GoodRecyclerViewAdapter(adapter);
    ...
    public GoodRecyclerViewAdapter getWrapper() {
        return adapter;
    }
